...
- The add dialog has a Ticker/Metal/Cash/Other type toggle. Metal picks from a fixed list (gold, silver, platinum, palladium) instead of the general ticker search — they still get a live quote, sparkline, and news attempt like any other ticker, and get their own "Metals" stat card.
